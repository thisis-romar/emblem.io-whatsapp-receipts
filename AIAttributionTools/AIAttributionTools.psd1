@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            LicenseUri = 'https://github.com/thisis-romar/emblem.io-whatsapp-receipts/blob/main/LICENSE'

            # A URL to the main website for this project
            ProjectUri = 'https://github.com/thisis-romar/emblem.io-whatsapp-receipts'

            # A URL to an icon representing this module
            IconUri = 'https://raw.githubusercontent.com/thisis-romar/emblem.io-whatsapp-receipts/main/docs/ai-attribution-icon.png'
...
For detailed usage: https://github.com/thisis-romar/emblem.io-whatsapp-receipts/blob/main/AIAttributionTools/README.md
"@
    ...
    HelpInfoURI = 'https://github.com/thisis-romar/emblem.io-whatsapp-receipts/blob/main/docs/help/'
